...
${YQ} merge --inplace --arrays=append -d'1' manifests/0000_50_olm_*-olm-operator.serviceaccount.yaml scripts/olm-service.patch.yaml
...
${YQ} merge --inplace manifests/0000_50_olm_*-olmconfig.yaml scripts/cluster-olmconfig.patch.yaml
